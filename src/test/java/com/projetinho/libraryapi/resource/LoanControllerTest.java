...
public class LoanControllerTest {
    ...
    @Test
    @DisplayName("Deve retornar erro ao tentar fazer emprestimo de um livro inesistente")
    public void invalidIsbnCreatLoanTest() throws Exception{
    ...
    public void LoanedBookErrorOnCreatLoanTest() throws Exception{
        ...
        BDDMockito.given( loanService.save(Mockito.any(Loan.class)) ).willThrow( new BusinessExeption("Book already loaned"));
